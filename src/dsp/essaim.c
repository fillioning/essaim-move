...
static void on_midi(void *instance, const uint8_t *msg, int len, int source) {
    ...
    /* Anchor on first note-on ever; never change it during playback.
       This avoids mapping changes for held notes. */
    if (status == 0x90 && vel > 0 && inst->pad_lowest_note == 128) {
        inst->pad_lowest_note = note;
    }

    /* Map MIDI note to voice 0-31 relative to lowest pad seen */
...
static const char CHAIN_PARAMS_JSON[] =
    ...
    "{\"key\":\"init_freq\",\"name\":\"Init Freq\",\"type\":\"enum\",\"options\":[\"Idle\",\"Trigger\"],\"access\":\"write\"},"
    "{\"key\":\"same_speed\",\"name\":\"Same Speed\",\"type\":\"float\",\"min\":0.05,\"max\":100,\"step\":0.05},"
    "{\"key\":\"rnd_mod\",\"name\":\"Rnd Mod\",\"type\":\"enum\",\"options\":[\"Idle\",\"Trigger\"],\"access\":\"write\"},"
    "{\"key\":\"rnd_pan\",\"name\":\"Rnd Pan\",\"type\":\"enum\",\"options\":[\"Idle\",\"Trigger\"],\"access\":\"write\"},"
    "{\"key\":\"all_mono\",\"name\":\"All Mono\",\"type\":\"enum\",\"options\":[\"Off\",\"On\"]},"
    "{\"key\":\"rnd_voice\",\"name\":\"Rnd Voice\",\"type\":\"enum\",\"options\":[\"Idle\",\"Trigger\"],\"access\":\"write\"},"
